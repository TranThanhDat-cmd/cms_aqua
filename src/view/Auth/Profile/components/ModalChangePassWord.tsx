...
const ModalChangePassWord = (props: IChangePassWord) => {
  ...
  return (
    ...
    >
      ...
      >
        <Form.Item
          label={formatMessage('reset.password.newPassword')}
          name="password"
          rules={[
            {
              required: true,
        ...
        >
          <Input.Password placeholder={formatMessage('reset.password.newPassword')} />
        </Form.Item>

        <Form.Item
          label={formatMessage('reset.password.confirm.newPassword')}
          ...
          rules={[
            ...
            ({ getFieldValue }) => ({
              validator(_, value) {
                ...
                return Promise.reject(new Error(formatMessage('reset.password.not.match')));
              },
            }),
          ]}
        >
          <Input.Password placeholder={formatMessage('reset.password.confirm.newPassword')} />
        </Form.Item>
